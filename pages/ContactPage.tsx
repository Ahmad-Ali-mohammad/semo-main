...
const ContactPage: React.FC = () => {
    ...
    if (!contactInfo) {
        return <div className="animate-fade-in text-center py-20">جار التحميل...</div>;
    }
        ...
        <div>
            <section className="text-center mb-12">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                    يسعدنا سماعك في أي وقت. اترك لنا بياناتك وسنرد عليك بكل التفاصيل.
                </p>
            </section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white/5 backdrop-filter backdrop-blur-lg border border-white/20 rounded-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <textarea placeholder="اكتب رسالتك هنا..." required rows={4} className="w-full bg-white/10 border border-white/20 rounded-lg py-2 px-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-400"></textarea>

        ...
        <div className="max-w-4xl mx-auto animate-fade-in text-right">
            ...
            <section className="mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {otherArticles.map(a => (
                        <div key={a.id} onClick={() => setPage(`article/${a.id}`)} className="glass-medium p-6 rounded-[2rem] border border-white/10 flex gap-6 hover:border-amber-500/50 transition-all cursor-pointer group">
                            <img src={a.image} className="w-24 h-24 rounded-2xl object-cover shrink-0 group-hover:scale-105 transition-transform" />
                            <div>
